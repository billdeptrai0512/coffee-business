-- ==============================================================================================
-- 20260906_bulk_create_orders_toppings.sql
-- Description: gắn topping (bảng toppings/topping_ingredients/product_toppings mới, xem
-- 20260906_toppings.sql) vào bulk_create_orders — cùng cách extra_ids đã làm cho product_extras/
-- extra_ingredients: giá + tên cộng vào v_extras_price/v_options_text, công thức topping cộng
-- vào v_line_cogs (giá vốn), rồi lưu topping_ids vào order_items.
--
-- Body copy nguyên văn từ 20260816_fix_bulk_create_orders_table_name_order_no.sql (bản mới nhất,
-- có table_name + order_no advisory-lock + ON CONFLICT DO NOTHING + discount clamp), chỉ thêm
-- đúng phần topping — không đổi gì khác.
--
